...
var (
	...
	vendoredSearchPaths = [][]string{
		...
		{"gopkg.in", "dnephin", "gometalinter.v1", "_linters"},
	}
)
...
func init() {
	...
	kingpin.Flag("deadline", "Cancel linters if they have not completed within this duration.").PlaceHolder("30s").DurationVar((*time.Duration)(&config.Deadline))
